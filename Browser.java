 ...
 * payForWine call the checkout and getSalesTotal methods from the Website object, 
 * followed by a thank you message in the terminal window. This method also amend
 * wineCase field back to null. Last but not least, the setWebsite method is accessed
 * from the Website object to amend the value of the 
 * website field.
 * */
...
public class Browser
{
    ...
    /**
     * This mutator method calls the checkout and setSalesTotal methods from 
     * the Website object and print thank you message in the tarminal window 
     * afterwords. Also, wineCase field is amended back to null.
     */
